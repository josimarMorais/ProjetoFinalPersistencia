...
<!-- 											<label for="dateData" class="form-label">Data </label>  -->
										...
										<div class="mb-3">
											<label for="dateData" class="form-label">Data </label> 
											<input type="date" class="form-control" id="dateData" name="dateData" required>
										</div>
										
										<div class="mb-3">
											<label for="timeHora" class="form-label">Hora </label> 
										...
										<div class="mb-3">
											...
											<textarea id="TextObservacoes" name="TextObservacoes" class="form-control" rows="2" cols="30" 
